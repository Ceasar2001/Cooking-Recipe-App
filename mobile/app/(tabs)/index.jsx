    ...
    <View style={homeStyles.container}>
      ...
      >
        ...
        {featuredRecipe && <View style={homeStyles.featuredSection}>
            <TouchableOpacity
              style={homeStyles.featuredRecipe}
              activeOpacity={0.9}
                ...
                <View style={homeStyles.featuredOverlay}>
                  ...
                  <View style={homeStyles.featuredContent}>
                    ...
                    <View style={homeStyles.featuredMeta}>
                      ...
                      <View style={homeStyles.metaItem}>
                        <Ionicons name="people-outline" size={16} color={COLORS.white}></Ionicons>
                        <Text style={homeStyles.metaText}>{featuredRecipe.servings}</Text>
                      </View>

                      <View style={homeStyles.metaItem}>
                        <Ionicons name="location-outline" size={16} color={COLORS.white}></Ionicons>
